            ...
            <div className="container"  align='center' style={{ marginTop: '120px' }}>
                        <Segment style={{border:"none"}}>
                            <Form style={{border:"none",width:"900px",backgroundColor:"lightgray",height:"330px",padding:"20px"}}>
                                ...
                                <a href="https://docs.google.com/spreadsheets/d/1lFSa_wh8wRtwZSuyVfRSwRsH2VuUldWJT1mZEM3uLwY/edit?usp=sharing" download style={{ color:"red"}}>Click Here to Download Sample csv</a>
                                </Form.Field>
                            </Form>
                        </Segment>
                    </div>
